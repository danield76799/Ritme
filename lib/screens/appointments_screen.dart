                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          if (doctor.isNotEmpty) Text('Dokter: $doctor', style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
                          if (location.isNotEmpty) Text('Locatie: $location', style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
                          Text('$date ${time.isNotEmpty ? 'om $time' : ''}', style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
                        ],
                      ),
                    ),
                  ],
